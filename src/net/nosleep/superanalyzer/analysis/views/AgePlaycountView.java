...
public class AgePlaycountView implements IStatisticView
{
	...
	public AgePlaycountView(Analysis analysis)
	{
	...
	private void createPanel()
	{
		...
		createChart();
		double factor = 0.7; //percentage of maximum available space in panel, numbers lower than 1 leads to upscaling
	...
	{
		_chart = ChartFactory.createScatterPlot(Misc.getString("AGE_VS_PLAYS"), Misc.getString("ALBUM_PLAY_COUNT"), Misc.getString("AGE"), _dataset,
				PlotOrientation.VERTICAL, false, true, false);

		_chart.addSubtitle(HomePanel
				.createSubtitle(Misc.getString("AGE_VS_PLAYS_SUBTITLE")));
